...
class Schedule(Base):
    ...
    schedule_process = Column(SmallInteger,default= 0,comment='在联赛时，为0，在杯赛时，1是小组赛，2是淘汰赛，')
    schedule_team_a = Column(Integer,comment='球队Aid')
    schedule_team_b = Column(Integer,comment='球队Bid')
    ...
    schedule_time = Column(Integer,comment='比赛时间')
